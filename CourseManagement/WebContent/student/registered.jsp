  ...
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    <%@ page session="true" %>
      <% model.User user=(model.User) session.getAttribute("user"); if (user==null || !"student".equals(user.getRole()))
        { response.sendRedirect("../index.jsp"); return; } EnrollmentDAO edao=new EnrollmentDAO(); List<Course>
        registered = edao.getCoursesOfStudent(user.getId());
        ...
        <body>
          <div class="container">
            ...
            <ul class="nav nav-pills">
              <li class="nav-item">
                <a class="nav-link" href="courses.jsp"><i class="bi bi-grid"></i> Browse Courses</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" href="registered.jsp"><i class="bi bi-bookmark-check"></i> My Courses</a>
              </li>
            </ul>
            ...
            <table class="table">
              ...
              <tbody>
                <c:forEach var="c" items="${registered}">
                  <tr>
